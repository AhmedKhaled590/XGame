...
namespace our
{
    ...
    glm::mat4 CameraComponent::getProjectionMatrix(glm::ivec2 viewportSize) const
    {
        ...
        //  For the orthographic camera, you can use glm::ortho
        //  HINT:
        //  - The aspect ratio is computed as viewportSize.x / viewportSize.y
        //  - The near and far values are stored in the CameraComponent
