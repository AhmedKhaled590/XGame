...
class FullscreenTriangleState : public our::State
{
    ...
    void onInitialize() override
    {
        ...
        glGenVertexArrays(1,  // Specifies the number of vertex array object names to generate.
                          &ID // reference to variable we will store the name (ID) for a vertex array
        );
